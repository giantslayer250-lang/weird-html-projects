...
const numBalls = 20;
const Speed = 11500; // max initial speed in px/s
...
function waterEnvironment() {
    environmentResistance = 0.2 // simulate water by increasing drag;
    console.log("Air friction increased:", environmentResistance);
    BGCOLOR = "rgba(53, 53, 212, 1)"; // change background color to blue for water simulation
